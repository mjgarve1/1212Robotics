...
public class LimelightHelpers {
    ...
    public static class PoseEstimate {
        ...
        public PoseEstimate(Pose2d pose, double timestampSeconds, double latency, 
            ...
            double avgTagArea, RawFiducial[] rawFiducials, boolean isMegaTag1) {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag1) {
        ...
        return new PoseEstimate(pose, adjustedTimestamp, latency, tagCount, tagSpan, tagDist, tagArea, rawFiducials, isMegaTag1);
    }
    ...
    public static void printPoseEstimate(PoseEstimate pose) {
        ...
        System.out.printf("Is MegaTag2: %b%n", pose.isMegaTag1);
        System.out.println();
