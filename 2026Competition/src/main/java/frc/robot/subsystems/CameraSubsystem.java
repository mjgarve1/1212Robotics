...
public class CameraSubsystem extends SubsystemBase {
  ...
  public CameraSubsystem() {
    ...
    SmartDashboard.putNumber("GetX", 0);
    SmartDashboard.putNumber("GetY", 0);
...
//mt1.pose,
            //mt1.timestampSeconds);g
            SmartDashboard.putNumber("GetX", mt1.pose.getX());
            SmartDashboard.putNumber("GetY", mt1.pose.getY());
            SmartDashboard.putNumber("Rotation", mt1.pose.getRotation().getDegrees());
      }
  }
}
